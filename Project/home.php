        ...
        <div class="container">
            <div class="row gy-4">
                <div
                    ...
                    <h1>
                        <!-- Welcome message that includes the user's "Name" -->
                        Welcome,<br />
                        <?php echo $Name; ?>!
                        <div class="loader">
            ...
            <h3>
                Your Satisfaction is Our Priority - Experience Excellence with Us!
            </h3>
        </div>
        <br />
        <hr />
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            SwiftStock. Update quantities, monitor stock levels,
                            and set reorder points with real-time updates.
                        </p>
                    </div>
                </div>
                <!-- Service Card 2 -->
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            functionality. Filter by category, SKU, or keyword
                            to locate products effortlessly.
                        </p>
                    </div>
                </div>
                <!-- Service Card 3 -->
